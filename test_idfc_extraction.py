#!/usr/bin/env python3
"""Test script for IDFC FIRST Bank FD rates extraction."""
...
def main():
    """Test IDFC FIRST Bank extraction."""
    config = Config()
    extractor = RateExtractor(config)
    
    url = "https://www.idfcfirst.bank.in/personal-banking/deposits/fixed-deposit/fd-interest-rates"
    
    print(f"Testing IDFC FIRST Bank extraction from: {url}\n")
